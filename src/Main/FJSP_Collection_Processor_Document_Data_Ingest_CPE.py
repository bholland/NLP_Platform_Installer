...
def generate_FJSP_Collection_Processor_Document_Data_Ingest(output_file, base_document_folder, database_server, database, database_user, database_password, database_port, use_job_queue):
