...
FJSP_Collection_Processor_Document_Data_Process = """<?xml version="1.0" encoding="UTF-8"?>
...
<cpeDescription>
    <collectionReader>
        <collectionIterator>
            <descriptor>
                <import location="./FJSP_FolderReader_Document_Data_Process_CPE.xml"/>
            </descriptor>
        </collectionIterator>
    </collectionReader>
...
def generate_FJSP_Collection_Processor_Document_Data_Process(output_file, cas_pool_size, threads):
    """output_file: a pathlib object"""
    s = Template(FJSP_Collection_Processor_Document_Data_Process)
