...
FJSP_FolderReader_Model_Data_Ingest_CPE = """<?xml version="1.0" encoding="UTF-8"?>
...
def generate_folder_reader_model_data_ingest_cpe(output_file, base_model_folder, database_server, database, database_user, database_password, database_port):
    """output_file: a pathlib object"""
    s = Template(FJSP_FolderReader_Model_Data_Ingest_CPE)
    ret = s.substitute(DATABASE_SERVER=database_server, DATABASE_USER=database_user, DATABASE=database,
                       DATABASE_PASSWORD=database_password, DATABASE_PORT=database_port, BASE_MODEL_FOLDER=base_model_folder)
