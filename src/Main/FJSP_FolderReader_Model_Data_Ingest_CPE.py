...
def generate_folder_reader_model_data_ingest_cpe(output_file, base_model_folder, database_server, database, database_user, database_password, database_port, use_job_queue):
