...
<cpeDescription>
    <collectionReader>
        <collectionIterator>
            <descriptor>
                <import location="./FJSP_FolderReader_Document_Data_Ingest_CPE.xml"/>
            </descriptor>
        </collectionIterator>
    </collectionReader>
...
def generate_FJSP_Collection_Processor_Document_Data_Ingest(output_file, cas_pool_size, threads):
